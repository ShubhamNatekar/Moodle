...
/**
 * Strings for component 'local_moodlemobileapp', language 'hi', branch 'MOODLE_26_STABLE'
 *
...
$string['addon.files.couldnotloadfiles'] = 'फाइलों की सूची लोड नहीं की जा सकी।';
$string['addon.files.emptyfilelist'] = 'दिखाने के लिए फाइलें नहीं हैं।';
$string['addon.files.erroruploadnotworking'] = 'दुर्भाग्य से वर्तमान में आपकी साइट पर फ़ाइलें अपलोड करना संभव नहीं है।';
...
$string['addon.mod_assign.userwithid'] = 'आईडी के साथ उपयोगकर्ता {{id}}';
...
$string['addon.mod_forum.refreshdiscussions'] = 'चर्चा को ताज़ा करें';
...
$string['addon.notes.userwithid'] = 'आईडी {{id}} के साथ उपयोगकर्ता';
...
$string['addon.storagemanager.managestorage'] = 'भंडारण प्रबंधित करें';
...
$string['core.android'] = 'एंड्रॉयड';
$string['core.browser'] = 'ब्राउज़र';
$string['core.cannotconnect'] = 'कनेक्ट नहीं कर सकता: सत्यापित करें कि आपने URL को सही प्रकार से टाइप किया है और आपकी साइट Moodle {{$a}} या बाद का उपयोग करती है।';
...
$string['core.confirmgotabroot'] = 'क्या आप सचमुच {{name}} पर वापस जाना चाहते हैं?';
...
$string['core.course.activitynotyetviewablesiteupgradeneeded'] = 'आपके संगठन की Moodle स्थापना को अद्यतन करने की आवश्यकता है।';
$string['core.course.allsections'] = 'सभी अनुभाग';
$string['core.course.askadmintosupport'] = 'साइट व्यवस्थापक से संपर्क करें और उन्हें बताएं कि आप इस गतिविधि का उपयोग Moodle मोबाइल ऐप के साथ करना चाहते हैं।';
$string['core.course.confirmdeletemodulefiles'] = 'क्या आप वाकई इन फ़ाइलों को हटाना चाहते हैं?';
...
$string['core.course.contents'] = 'अंतर्वस्तु';
...
$string['core.login.invalidmoodleversion'] = 'अमान्य Moodle संस्करण। आवश्यक न्यूनतम संस्करण 2.4 है।';
...
$string['core.login.localmobileunexpectedresponse'] = 'Moodle मोबाइल एडिशनल फीचर्स चेक ने अप्रत्याशित प्रतिक्रिया दी। आपको मानक मोबाइल सेवा का उपयोग करके प्रमाणित किया जाएगा।';
...
$string['core.login.newsitedescription'] = 'कृपया अपनी Moodle साइट का URL दर्ज करें। ध्यान दें कि इस ऐप के साथ काम करने के लिए इसे कॉन्फ़िगर नहीं किया जा सकता है।';
$string['core.login.notloggedin'] = 'आपको लॉग इन करने की जरूरत है।';
$string['core.login.passwordrequired'] = 'पासवर्ड आवश्यक';
$string['core.login.problemconnectingerror'] = 'हमें कनेक्ट करने में समस्या हो रही है';
$string['core.login.problemconnectingerrorcontinue'] = 'दोबारा जांच करें कि आपने पता सही दर्ज किया है और पुनः प्रयास करें।';
...
$string['core.login.reconnectdescription'] = 'आपका प्रमाणीकरण टोकन अमान्य है या समाप्त हो चुका है। आपको साइट को फिर से कनेक्ट करना होगा।';
...
$string['core.mainmenu.appsettings'] = 'एप्लिकेशन सेटिंग';
$string['core.mainmenu.changesite'] = 'साइट बदलें';
$string['core.mainmenu.website'] = 'वेबसाइट';
...
$string['core.question.errorattachmentsnotsupported'] = 'एप्लिकेशन उत्तर देने के लिए फ़ाइलों को संलग्न करने का समर्थन नहीं करता है।';
$string['core.question.errorinlinefilesnotsupported'] = 'एप्लिकेशन अभी तक इनलाइन फ़ाइलों के संपादन का समर्थन नहीं करता है।';
...
$string['core.settings.appready'] = 'ऐप तैयार है';
...
$string['core.settings.deletesitefiles'] = 'क्या आप वाकई \'{{sitename}}\' साइट से डाउनलोड की गई फ़ाइलों को हटाना चाहते हैं?';
$string['core.settings.deletesitefilestitle'] = 'साइट फ़ाइलें हटाएं';
$string['core.settings.deviceinfo'] = 'यंत्र की जानकारी';
$string['core.settings.deviceos'] = 'डिवाइस ओएस';
$string['core.settings.devicewebworkers'] = 'डिवाइस वेब कार्यकर्ताओं ने समर्थन किया';
...
$string['core.settings.errordeletesitefiles'] = 'साइट फ़ाइलों को हटाने में त्रुटि।';
...
$string['core.settings.versioncode'] = 'संस्करण कोड';
$string['core.settings.versionname'] = 'संस्करण का नाम';
...
$string['core.windowsphone'] = 'विंडोज फ़ोन';
