...
/**
 * Strings for component 'block', language 'hi', branch 'MOODLE_38_STABLE'
 *
 * @package   block
...
$string['addtodock'] = 'इसे डॉक में ले जाएं';
...
$string['dockblock'] = 'डॉक {$a} ब्लॉक';
$string['hideblock'] = 'ब्लॉक {$a} छिपाए';
$string['hidedockpanel'] = 'डॉक पैनल छुपाएं';
...
$string['undockall'] = 'सभी को अनदेखा करें';
$string['undockblock'] = '{$a} ब्लॉक अनदेखा करें';
$string['undockitem'] = 'इस आइटम को अनदेखा करें';
